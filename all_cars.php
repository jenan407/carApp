...
<body class="bg-silver">
    ...
    <div class="container mt-4">
        <h1 class="text-center mb-4" data-lang="AllCars">All Cars</h1>
        <div class="row car-grid">
            <?php
            include 'db_connection.php';

            $sql = "SELECT id, brand, model, year, price, images FROM cars";
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo "<div class='col-12'><p data-lang='NoCarsAvailable'>No cars available</p></div>";
            }
            $conn->close();
            ?>
        </div>
